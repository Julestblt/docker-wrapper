...
class TestDockerWizard:
    ...
    def test_container_selection_wizard_exit(self, mock_questionary, wizard, mock_docker_client, mock_container):
    ...
    @mock.patch('docker_tool.wizard.questionary')
    def test_container_selection_wizard_select_container(self, mock_questionary, wizard, mock_docker_client, mock_container):
    ...
    @mock.patch('docker_tool.wizard.questionary')
    def test_manage_container_shell_action(self, mock_questionary, wizard, mock_container, mock_docker_client):
        ...
        with mock.patch('docker_tool.wizard.console'):
            with mock.patch('builtins.input'):  # Mock input for "Press Enter to continue"
                ...
                mock_docker_client._spawn_shell_in_container.assert_called_once_with(mock_container, "/bin/bash")
    
    @mock.patch('docker_tool.wizard.questionary')
    def test_execute_action_exec(self, mock_questionary, wizard, mock_container, mock_docker_client):
        ...
        with mock.patch('docker_tool.wizard.console'):
            with mock.patch('builtins.input'):  # Mock input for "Press Enter to continue"
                ...
                mock_docker_client._exec_cmd_in_container.assert_called_once_with(mock_container, "ls -la")
    
    @mock.patch('docker_tool.wizard.questionary')
    def test_execute_action_logs(self, mock_questionary, wizard, mock_container, mock_docker_client):
        ...
        with mock.patch('docker_tool.wizard.console'):
            with mock.patch('builtins.input'):  # Mock input for "Press Enter to continue"
                ...
                mock_docker_client._fetch_logs_from_container.assert_called_once_with(mock_container, follow=True)
